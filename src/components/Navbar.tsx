        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <a
              ...
              className="hidden sm:inline-flex items-center gap-2 font-heading font-bold text-xs sm:text-sm tracking-wider uppercase text-obsidian bg-marigold border-2 border-obsidian px-4 py-2 shadow-[3px_3px_0_#C1121F] hover:bg-yellow-400 hover:translate-x-[-1px] hover:translate-y-[-1px] transition-all"
            >
        ...
        {isOpen && (
          ...
          >
            ...
            <a
              ...
              rel="noopener noreferrer"
              onClick={() => setIsOpen(false)}
              className="w-full mt-2 font-heading font-extrabold text-sm tracking-wider uppercase text-obsidian bg-marigold border-2 border-obsidian py-3 shadow-[4px_4px_0_#C1121F] flex items-center justify-center gap-2"
            >
              <Sparkles className="w-4 h-4 text-obsidian animate-pulse" />
              Register for AIVORA 2K26
